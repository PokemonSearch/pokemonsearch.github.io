...
async function load()
{
    ...
    if(dmg_calc.rawDesc.defenseEVs == "252+ SpD" || dmg_calc.rawDesc.defenseEVs == "0+ SpD"){ui.push(new label("SpD Boosting Nature", 3*w/4 + 128*gra_scale + 64*gra_scale, h/2 + 64*gra_scale, 20*gra_scale, [200, 100, 100, 1], 1.625));}
    if(dmg_calc.rawDesc.defenseEVs == "252- SpD" || dmg_calc.rawDesc.defenseEVs == "0- SpD"){ui.push(new label("SpD Lowering Nature", 3*w/4 + 128*gra_scale + 64*gra_scale, h/2 + 64*gra_scale, 20*gra_scale, [100, 100, 200, 1], 1.625));}
    if(dmg_calc.rawDesc.defenseEVs == "252+ Def" || dmg_calc.rawDesc.defenseEVs == "0+ Def"){ui.push(new label("Def Boosting Nature", 3*w/4 + 128*gra_scale + 64*gra_scale, h/2 + 64*gra_scale, 20*gra_scale, [200, 100, 100, 1], 1.625));}
    if(dmg_calc.rawDesc.defenseEVs == "252- Def" || dmg_calc.rawDesc.defenseEVs == "0- Def"){ui.push(new label("Def Lowering Nature", 3*w/4 + 128*gra_scale + 64*gra_scale, h/2 + 64*gra_scale, 20*gra_scale, [100, 100, 200, 1], 1.625));}
