class Panel
{
    ...
    draw()
    {
        ...
        if(types.length == 1)
        {
            instant_text(titleCase(types[0].type.name), fontSize, w*0.45 + imageSize/2, this.y + height*0.3 + imageSize/2 + fontSize, w/2, color(255), true);
        }
        else
        {
            instant_text(titleCase(types[0].type.name) + " / " + titleCase(types[1].type.name), fontSize, w*0.45 + imageSize/2, this.y + height*0.3 + imageSize/2 + fontSize, w/2, color(255), true);
        }
