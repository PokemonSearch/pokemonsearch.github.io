...
declare const Analyses: {
     ...
     */
    url(pokemon: string, gen?: GenerationNum): string;
    /**
     * Returns the Analysis RPC URL and request configuration for a given pokemon and gen.
     */
    request(pokemon: string, gen?: GenerationNum, language?: string): {
        url: string;
        init: {
            method: string;
            headers: {
     ...
     * was invalid.
     */
    process(ds: string | DexSettings | DexDumpPokemonResponse): Map<string, Analysis[]> | undefined;
    /**
     * Returns Smogon's display representation of the given gen.
     */
    gen(gen: GenerationNum): string;
};
type Report = 'usage' | 'leads' | 'moveset' | 'metagame' | 'chaos';
declare const Statistics: {
     ...
     */
    url(date: string, format: string, weighted?: number | boolean, report?: Report): string;
    /**
     ...
     */
    latestDate(format: string, best?: boolean): Promise<{
        date: string;
        count: number;
    } | undefined>;
    /**
...
export { Analyses, Analysis, Credits, GenerationNum, ID, Member, Moveset, MovesetStatistics, Report, StatID, Statistics, StatsTable, TypeName, UsageStatistics };
