...
interface LegacyDisplayStatistics extends Omit<DisplayStatistics, 'metagame'> {
    metagame?: DisplayMetagameStatistics;
}
...
declare class Smogon {
     ...
     */
    stats(gen: Generation, species: string | Specie, format?: ID): Promise<DisplayUsageStatistics | undefined>;
...
export { Analysis, DeepPartial, DisplayMetagameStatistics, DisplayStatistics, DisplayUsageStatistics, LegacyDisplayStatistics, LegacyDisplayUsageStatistics, Moveset, Smogon, Usage };
